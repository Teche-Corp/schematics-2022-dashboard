...
export default function DragnDropInputPayment({
  accept,
  id,
  label,
  helperText = '',
  ...
  return (
    <>
      <label
        className='block text-sm font-normal text-white font-secondary'
        htmlFor={id}
      >
        {label}
      </label>
          ...
          render={(controllerProps) => (
            <>
              <div className='mt-1' {...getRootProps()}>
                ...
                >
                  <p className='my-20 text-center text-gray-500 font-secondary'>
              ...
              <div className='mt-1'>
                {helperText !== '' && (
                  <p className='text-xs text-white font-secondary'>
                    {helperText}
                  </p>
                )}
                {errors[id] && (
