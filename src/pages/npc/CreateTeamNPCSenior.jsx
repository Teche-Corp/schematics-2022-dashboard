                        ...
                        <div className='flex justify-center px-6 pt-5 pb-6 mt-1 border-2 border-gray-300 border-dashed rounded-md'>
                          <div className='space-y-1 text-center'>
                            ...
                            <div className='flex text-sm text-gray-600'>
                              <label
                                htmlFor='file-upload-leader'
                                className='relative font-medium bg-white rounded-md cursor-pointer text-npc-400 hover:text-npc-700 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-npc-400'
                              >
                                <span>Upload a file</span>
                                <input
                                  id='file-upload-leader'
                                  name='leader-student-id'
                                  type='file'
                                  className='sr-only'
                                />
                              </label>
                      ...
                      <div className='sm:col-span-6'>
                        ...
                        <div className='flex justify-center px-6 pt-5 pb-6 mt-1 border-2 border-gray-300 border-dashed rounded-md'>
                          <div className='space-y-1 text-center'>
                            ...
                            <div className='flex text-sm text-gray-600'>
                              <label
                                htmlFor='file-upload-member-1'
                                className='relative font-medium bg-white rounded-md cursor-pointer text-npc-400 hover:text-npc-700 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-npc-400'
                              >
                                <span>Upload a file</span>
                                <input
                                  id='file-upload-member-1'
                                  name='member1-student-id'
                                  type='file'
                                  className='sr-only'
                                />
                              </label>
                      ...
                      <div className='sm:col-span-6'>
                        ...
                        <div className='flex justify-center px-6 pt-5 pb-6 mt-1 border-2 border-gray-300 border-dashed rounded-md'>
                          <div className='space-y-1 text-center'>
                            ...
                            <div className='flex text-sm text-gray-600'>
                              <label
                                htmlFor='file-upload-member-2'
                                className='relative font-medium bg-white rounded-md cursor-pointer text-npc-400 hover:text-npc-700 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-npc-400'
                              >
                                <span>Upload a file</span>
                                <input
                                  id='file-upload-member-2'
                                  name='member2-student-id'
                                  type='file'
                                  className='sr-only'
                                />
                              </label>
