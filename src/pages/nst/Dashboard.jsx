              ...
              <div className='mb-8 w-full  flex  justify-center md:block md:w-1/4 md:mb-0'>
                <div className=' bg-white w-10/12 rounded-3xl h-full md:w-full'>
                  <div className='mx-5 flex flex-col justify-center'>
                    ...
                    {data?.data.status === 'active' ? (
                      <a
                        className=' mb-4 flex justify-center bg-nst hover:bg-nst-400 font-primary h-10 rounded-xl w-full text-white items-center md:mb-4'
                        href={`${process.env.PUBLIC_URL}/nst/ticket`}
                      >
                        Lihat Tiket Disini
                      </a>
                    ) : (
                      <p className='font-secondary text-red-500 font-semibold text-center mb-4'>
